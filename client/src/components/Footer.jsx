const Footer = () => {
  return (
    <div className="bg-[#232536] py-5 md:px-16 px-7 text-white">
      <div className="flex md:flex-row flex-col  items-center justify-between md:m-5 my-5">
        <div className="">
          {/* <img className="w-5 h-5" src="logo" alt="logo" /> */}
          <span className="font-bold text-white text-3xl">{"{Finsweet"}</span>
        </div>

        <div className="flex flex-wrap items-center mt-5 justify-center gap-4  ">
          <a href="/home ">Home</a>
          <a href="/home ">Blog</a>
          <a href="/home ">About us </a>
          <a href="/home ">Contact us </a>
          <a href="/home ">Privicy Policy </a>
        </div>
      </div>

      <div className="bg-[#6D6E76]/5 flex md:flex-row flex-col items-center md:justify-around justify-center rounded-sm md:m-10 px-10 py-16 ">
        <div className="opacity-100 text-center">
          <h2 className="text-white font-bold text-3xl md:mb-0 mb-5">
            Subscribe to our news letter to get <br /> latest updates and news
          </h2>
        </div>
        <div className="flex md:flex-row flex-col justify-center items-center gap-4">
          <input
            className="border border-[#4C4C4C] py-2 px-4 md:mr-4 mr-0 outline-none rounded-sm"
            type="text"
            placeholder="Enter Your Email"
          />
          <button className="py-2 px-6 border border-[#4C4C4C] bg-[#FFD050] text-[#232536] hover:bg-[#232536] hover:text-[#FFD050] font-semibold rounded-sm transition-all duration-300">
            Subscribes
          </button>
        </div>
      </div>
