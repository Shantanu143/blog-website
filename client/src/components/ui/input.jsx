...
const Input = React.forwardRef(({ className, type, as = "input", options = [], ...props }, ref) => {
      ...
      {as === "select" ? (
        <select
          className={cn(
            ...
            rounded-md px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-[2px] 
        ...
        <textarea
          className={cn(
            `flex w-full h-32 border-none bg-gray-50 dark:bg-zinc-800 text-black dark:text-white shadow-input 
            rounded-md px-3 py-2 text-sm resize-none 
